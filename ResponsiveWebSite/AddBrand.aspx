        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorPName" CssClass="text-danger" runat="server" ErrorMessage="This filed is required" ControlToValidate="txtBrandName"></asp:RequiredFieldValidator>
                </div>
            </div>
